...
def create_object(bucket_name, s3_key, aws_cred, file=''):
    
    '''
    if the [file='' (default)] this function will create a new directory with 
    ...
    print 'Added new object', 's3://' + bucket_name + ':' + subdirectory_name + file
